...
description: 六爻占卜服务，支持起卦占卜和问答聊天两种模式。触发关键词：妖妖、六爻、起卦、占卜、算卦、卜卦、摇卦、排卦、问卦、解卦、运势、姻缘、事业、财运、健康、出行等。当用户表达占卜意图、以"妖妖"开头提问、或发送lyk-开头的API Key时，使用此技能。
---
...
5. **服务地址**：默认连接 `http://localhost:7999`
